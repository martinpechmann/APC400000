# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\Push\UserSettingsComponent.py
...
class UserComponent(ActionWithSettingsComponent):
    ...
    def __init__(self, value_control = None, *a, **k):
        ...
        if value_control == None: raise AssertionError
