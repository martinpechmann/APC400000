# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\Push\AutoArmComponent.py
"""
...
class AutoArmComponent(CompoundComponent):
    ...
    def auto_arm_restore_behaviour(self, *extra_classes, **extra_params):
        if not self._auto_arm_restore_behaviour:
            ...
            if extra_params and not extra_classes: raise AssertionError
