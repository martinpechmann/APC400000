# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\Push\TrackFrozenMode.py
...
class TrackFrozenModesComponent(ModesComponent):
    ...
    def __init__(self, default_mode = None, frozen_mode = None, *a, **k):
        ...
        if default_mode is None: raise AssertionError
