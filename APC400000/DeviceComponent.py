...
class DeviceComponent(DeviceComponentBase, CompoundComponent):
    ...
    def number_of_parameter_banks(self):
    ...
    def get_bank_index(self):
        return self._bank_index if self._bank_index != None else 0

    def select_bank_index(self, bank):
    ...
    def on_device_bank_changed(self, device, bank):
