# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\Push\ViewControlComponent.py
import Live
...
class ViewControlComponent(CompoundComponent):
    ...
    def show_view(self, view):
        if not view in VIEWS: raise AssertionError
