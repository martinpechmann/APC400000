# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\Push\ActionWithOptionsComponent.py
...
class OptionsComponent(ControlSurfaceComponent):
    ...
    def _set_selected_option(self, selected_option):
        if not (in_range(selected_option, 0, len(self.option_names)) or selected_option is None): raise AssertionError
