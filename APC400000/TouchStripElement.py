# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\Push\TouchStripElement.py
import Live
import Sysex
...
class TouchStripElement(InputControlElement, SlotManager):
    ...
    def turn_on_index(self, index, on_state = STATE_FULL, off_state = STATE_OFF):
        if not in_range(index, 0, self.STATE_COUNT): raise AssertionError
