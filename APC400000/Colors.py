# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\Push\Colors.py
"""
...
class RgbColor(Color):
    ...
    def shade(self, shade_level):
        ...
        """
        if not (shade_level > 0 and shade_level <= 2): raise AssertionError
...
class AnimatedColor(Color):
    ...
    def draw(self, interface):
        if not interface.num_delayed_messages >= 2: raise AssertionError
